...
# os.system('python3 comparer.py bike bike --available_classes bicycle person')
# os.system('python3 comparer.py bike2 bike2 --available_classes bicycle person')
# os.system('python3 comparer.py bike3 bike3 --available_classes bicycle person')
# os.system('python3 comparer.py bike4 bike4 --available_classes bicycle person')
# os.system('python3 comparer.py bike5 bike5 --available_classes bicycle person')
# os.system('python3 comparer.py bike6 bike6 --available_classes bicycle person')
# os.system('python3 comparer.py pitbull pitbull --available_classes dog person bicycle handbag')
